...
export default function CookiePolicyPage() {
  return <LegalPageLayout title="Çerez Politikası" subtitle="Sürüm: 13 Ağustos 2026">
    ...
    <h2>5. Üçüncü taraflar</h2><ul><li>Supabase: kimlik doğrulama ve zorunlu oturum yönetimi</li><li>PostHog: izinli ürün analitiği</li><li>Google Analytics: izinli toplu trafik analizi</li><li>Sentry: güvenlik ve teknik hata kaydı</li></ul>
  </LegalPageLayout>;
}
