...
export default function PreInformationPage() {
  ...
  return <LegalPageLayout title="Ön Bilgilendirme Formu" subtitle="Sürüm: 13 Ağustos 2026 · Siparişe özel tutar ödeme öncesinde ayrıca gösterilir.">
    ...
    <h2>2. Hizmetin temel nitelikleri</h2><p>calisiyo ücretsiz ve calisiyo plus; YKS çalışma planlama, kayıt, analiz ve çalışma sınıfı özelliklerini seçilen planın belirtilen limitleriyle sunan dijital hizmetlerdir. calisiyo plus, YKS 2028 için 6 ay; YKS 2027 için 19 Ağustos 2027 tarihine kadar geçerli ön ödemeli erişim seçeneğidir.</p>
    ...
    <h2>4. İfa ve süre</h2><p>Ödeme Shopier kayıtları üzerinden sunucu tarafında doğrulandıktan sonra erişim kullanıcı hesabına tanımlanır. YKS 2027 seçeneği 19 Ağustos 2027’ye kadar, YKS 2028 seçeneği 6 ay sürer. Paket otomatik yenilenmez; sürenin sonunda ücret alınmadan calisiyo ücretsiz planına dönülür.</p>
