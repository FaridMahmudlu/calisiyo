...
export default function DistanceSalesPage() {
  ...
  return <LegalPageLayout title="Mesafeli Satış Sözleşmesi" subtitle="Sürüm: 13 Ağustos 2026 · Sözleşme, kullanıcı siparişi onayladığında sipariş bilgileriyle birlikte kurulur.">
    ...
    <h2>3. Paket, süre ve bedel</h2><p>calisiyo plus seçeneğinin YKS dönemi, erişim süresi ve vergiler dahil toplam bedeli sipariş özetinde ve ödeme sağlayıcısının sayfasında gösterilir. Otomatik yenileme veya saklı tekrar tahsilat yoktur.</p>
