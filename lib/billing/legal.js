...
export function createLegalSnapshot({ planCode, planName, billingPeriod, amount, orderNumber, pricing = null }) {
  ...
  const snapshot = {
    ...
    order: {
      planCode, planName, billingPeriod, amount, currency: 'TRY', orderNumber,
      ...(pricing ? { pricing } : {}),
    },
    terms: {
      autoRenewal: false,
