...
function configuredSameAs(value) {
  return String(value || '')
    .split(',')
    .map((item) => item.trim())
    .filter(Boolean)
...
export const SITE = Object.freeze({
  name: 'calisiyo',
  visualName: 'calisiyo',
  displayName: 'Calisiyo',
  productTitle: 'Calisiyo — YKS Çalışma Koçu',
  ...
  sameAs: Object.freeze(configuredSameAs(process.env.NEXT_PUBLIC_OFFICIAL_SOCIAL_URLS)),
});
