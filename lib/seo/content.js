export const CONTENT_UPDATED_AT = '2026-08-30';
...
export const GUIDES = Object.freeze([
  ...
  },
  {
    ...
    sources: [],
    related: ['yks-calisma-programi', 'yks-deneme-analizi'],
    feature: 'kronometre-ve-istatistikler',
    cta: { label: 'Gerçek çalışma kayıtlarını tutmaya başla', href: '/kayit' },
  },
  {
    slug: 'youtube-kampini-calisma-programina-donusturme',
    kicker: 'Video planlama rehberi',
    title: 'YouTube kampı çalışma programına nasıl dönüştürülür?',
    description: 'YouTube video ve oynatma listelerini başlangıç noktası, gerçek video süreleri ve günlük kapasiteyle uygulanabilir YKS görevlerine dönüştürme rehberi.',
    summary: 'Kampı baştan elle yazmak yerine video sırasını koru, nereden başlayacağını belirle ve görevleri gerçek günlük kapasitenle eşleştir.',
    answer: 'Bir YouTube kampını çalışma programına dönüştürmek için önce erişilebilir video listesini ve sürelerini çıkar, hangi video ve dakikadan başlayacağını belirle, ardından günlük ayırabildiğin süreye göre sırala. Oluşan görevleri kaydetmeden önce tarih, ders ve video başlığını kontrol et; aynı aktarımı tekrar yaptığında kopya görev oluşmamasını sağla.',
    publishedAt: '2026-08-30',
    updatedAt: '2026-08-30',
    sections: [
      {
        title: 'Kampın tamamını değil, gerçek başlangıç noktanı planla',
        paragraphs: ['Bir kampın ilk 24 videosunu zaten tamamladıysan planı yeniden ilk videodan kurmak gereksiz görev üretir. Başlangıç videosunu ve gerekiyorsa o videodaki dakika konumunu yaz; ilk görevin yalnızca kalan kısmı temsil etmesini sağla.'],
        checklist: ['Video veya oynatma listesi herkese açık mı?', 'Başlangıç videosu doğru mu?', 'İlk videoda kaldığın dakika belli mi?', 'Ders ve sınav türü doğru seçildi mi?'],
      },
      {
        title: 'Günlük dakika hedefini video süreleriyle birlikte düşün',
        paragraphs: ['Günlük 80 dakika hedef, her gün tam olarak 80 dakikalık video demek değildir. Bir video hedefi aşıyorsa sırf takvime sığdırmak için yapay parçalar oluşturmak yerine o videoyu tek görevde tutmak daha anlaşılırdır. Kısa videolar ise sıra korunarak aynı gün içinde gruplanabilir.'],
        table: { headers: ['Video süresi', 'Günlük hedef', 'Pratik karar'], rows: [['35 dk + 42 dk', '80 dk', 'İki videoyu aynı güne yerleştir'], ['95 dk', '80 dk', 'Videoyu tek görev olarak o güne bırak'], ['60 dk, ilk 20 dk izlendi', '80 dk', 'Kalan 40 dakikayı başlangıç görevi yap']] },
      },
      {
        title: 'Aktarmadan önce görevi kontrol et',
        steps: [['1', 'Başlıkları incele', 'Silinmiş veya erişilemeyen video var mı kontrol et.'], ['2', 'Tarihleri gözden geçir', 'Okul ve deneme günleriyle çakışan yoğunluğu elle düzenle.'], ['3', 'Ders eşleşmesini doğrula', 'Görevlerin doğru ders ve sınav türünde olduğunu gör.'], ['4', 'Bir kez aktar', 'İşlem sürerken yeniden göndermeyi deneme; hata varsa güvenli biçimde tekrar et.']],
      },
      {
        title: 'Video izlemeyi öğrenme çıktısına bağla',
        paragraphs: ['Bir videonun tamamlanması konunun öğrenildiğini tek başına kanıtlamaz. Video görevine konu soruları, kısa not veya sonraki denemede kontrol edilecek bir çıktı ekle. Böylece kamp takvimi yalnızca izleme listesi olmaktan çıkar.'],
        callout: 'Calisiyo video içeriklerini üretmez ve videonun akademik doğruluğunu değerlendirmez. Plan, seçtiğin içeriği zamanına dağıtmana yardımcı olur.',
      },
    ],
    sources: [],
    related: ['yks-calisma-programi', 'yks-calisma-suresi-takibi'],
    feature: 'youtube-calisma-plani',
    cta: { label: 'YouTube kampını planlamaya başla', href: '/kayit' },
  },
  {
    slug: 'calisma-sinifi-ile-birlikte-calisma',
    kicker: 'Birlikte çalışma rehberi',
    title: 'Canlı çalışma sınıfı nasıl verimli kullanılır?',
    description: 'Ortak odak, görünür çalışma durumu, sınıf tahtası ve mesajlaşmayı dikkat dağıtmadan kullanmak için küçük gruplara yönelik çalışma sınıfı rehberi.',
    summary: 'Birlikte çalışmayı sürekli sohbet etmek yerine ortak başlangıç, görünür durum ve kısa geri bildirim anları etrafında düzenle.',
    answer: 'Canlı çalışma sınıfını verimli kullanmak için önce herkesin çalışma konusunu ve durumunu görünür yap, 15–50 dakikalık ortak bir odak süresi seç ve seans boyunca mesajları yalnızca gerekli paylaşımlar için kullan. Seans sonunda kısa bir sonuç paylaşımı yap; sınıf tahtasını ortak hedef veya çözülecek soru için kullan.',
    publishedAt: '2026-08-30',
    updatedAt: '2026-08-30',
    sections: [
      {
        title: 'Sınıfa girmeden önce ortak kuralı belirle',
        paragraphs: ['Küçük bir sınıfta en önemli karar, odak sırasında iletişimin nasıl olacağıdır. Herkes çalıştığı dersi yazabilir; acil olmayan mesajlar odak sonuna bırakılabilir. Bu düzen, çevrim içi olmayı sürekli sohbet etme baskısına dönüştürmez.'],
        checklist: ['Seans süresi belli mi?', 'Herkes çalışacağı konuyu yazdı mı?', 'Soru paylaşımı için ortak yöntem belirlendi mi?', 'Mola ve bitiş zamanı net mi?'],
      },
      {
        title: 'Ortak odağı küçük ve ölçülebilir tut',
        table: { headers: ['Süre', 'Uygun kullanım'], rows: [['15 dk', 'Kısa tekrar veya gün başlangıcı'], ['25 dk', 'Tek konu veya soru seti'], ['40 dk', 'Yoğun konu çalışması'], ['50 dk', 'Uzun deneme analizi ya da video çalışması']] },
        paragraphs: ['İlk seansı gereğinden uzun seçmek yerine grubun gerçekten tamamlayabildiği süreyle başla. Süre bittiğinde herkes tek cümleyle neyi tamamladığını paylaşabilir.'],
      },
      {
        title: 'Sohbeti çalışma kaynağı olarak kullan',
        steps: [['1', 'Metinle bağlam ekle', 'Paylaşılan görsel veya dosyanın neden gönderildiğini yaz.'], ['2', 'Gerekli formatı seç', 'Soru için görsel, uzun kaynak için dosya, kısa açıklama için ses kullan.'], ['3', 'Okundu bilgisini doğru yorumla', 'Görüldü bilgisi, karşı tarafın içeriği çalıştığı anlamına gelmez.'], ['4', 'Eski içeriği düzenle', 'Kendi hatalı mesajını düzenle veya gerektiğinde sil.']],
      },
      {
        title: 'Görsel sınıfı isteğe göre kullan',
        paragraphs: ['Karakter hareketi, koltuklar ve sınıf tahtası birlikte çalışma hissini güçlendirebilir; ancak her çalışma için gerekli değildir. Küçük ekran, düşük bağlantı veya sade görünüm tercihi varsa görsel sınıfı kapatıp odak ve sohbet araçlarıyla devam et.'],
        callout: 'Sınıf üyeliği özel çalışma kayıtlarını otomatik olarak paylaşmaz. Yalnızca kullanıcının sınıfta açıkça paylaştığı durum ve içerikler diğer üyelere görünür.',
      },
    ],
    sources: [],
    related: ['yks-calisma-suresi-takibi', 'yks-calisma-programi'],
    feature: 'calisma-siniflari',
    cta: { label: 'Çalışma sınıfını kullanmaya başla', href: '/kayit' },
  },
]);
...
export const PUBLIC_INDEXABLE_ROUTES = Object.freeze([
  ...
  { path: '/hakkimizda', lastModified: CONTENT_UPDATED_AT },
  { path: '/ozellikler', lastModified: CONTENT_UPDATED_AT },
  { path: '/ozellikler/youtube-calisma-plani', lastModified: CONTENT_UPDATED_AT },
  { path: '/ozellikler/calisma-siniflari', lastModified: CONTENT_UPDATED_AT },
  { path: '/ozellikler/yks-planlama', lastModified: CONTENT_UPDATED_AT },
  { path: '/ozellikler/kronometre-ve-istatistikler', lastModified: CONTENT_UPDATED_AT },
  { path: '/ozellikler/deneme-analizi', lastModified: CONTENT_UPDATED_AT },
  { path: '/ozellikler/konu-takibi', lastModified: CONTENT_UPDATED_AT },
  { path: '/paketler', lastModified: CONTENT_UPDATED_AT },
